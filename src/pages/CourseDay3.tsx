      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="relative bg-gradient-to-br from-pink-100 via-rose-50 to-pink-100 rounded-3xl p-8 sm:p-12 text-center overflow-hidden">
            ...
            <img 
              src="/images/courses/day3/art-easel.png" 
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <img 
              src="/images/courses/day3/robot-painting.png" 
              alt="Maler-Roboter" 
    ...
    // ========================================================================
    {
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <img 
              src="/images/courses/day3-extra/story-magic.png" 
    ...
    // ========================================================================
    {
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <img 
              src="/images/courses/day3/robot-artist.png" 
...
- Refrain (final)`}
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border-2 border-green-200 p-6 sm:p-8">
            <div className="flex items-center gap-4 mb-6">
              <img 
                src="/images/courses/day3/music-notes.png" 
                alt="Musik-Noten" 
                className="w-16 h-16"
              />
              <div>
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-br from-pink-100 via-rose-50 to-pink-100 rounded-3xl p-8 text-center">
            <img 
              src="/images/courses/day3-extra/robot-artist-painting.png" 
              alt="Künstler-Roboter" 
