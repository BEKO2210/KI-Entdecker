...
const CourseDay1 = ({ progress }: CourseDayProps) => {
  ...
  useEffect(() => {
    ...
    // Set minimum reading time before "Weiter" is allowed
    ...
    if (activeSection === 4) { // CourseDay1 has 5 sections (0 to 4)
      completeDay(1);
    }
...
Stell dich vor und frag mich, welches Tier mich interessiert!`}
  ...
  return (
    <CourseDayLayout
      dayNumber={1}
      title="Was ist KI?"
      subtitle="Die Grundlagen der Künstlichen Intelligenz verstehen"
      colorScheme="purple"
      sections={sections}
